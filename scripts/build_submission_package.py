...
def main() -> None:
    ...
    ap.add_argument("--variant", choices=list(VARIANT_CONFIG), default="stanford",
                    help="Which submission flavour to build (default: stanford — the "
                         "canonical 196-class submission, val acc 0.7703). Pass "
                         "--variant=vmmrdb for the legacy 1163-class VMMRdb build "
                         "(now archived under notebooks/legacy/).")
